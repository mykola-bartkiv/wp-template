            ...
            <?php elseif ( get_row_layout() == 'instagram' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Instagram</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-instagram fa-w-14 fa-3x">
            ...
            <?php elseif ( get_row_layout() == 'youtube' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Youtube</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-youtube fa-w-18 fa-3x">
            ...
            <?php elseif ( get_row_layout() == 'vimeo' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Vimeo</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-vimeo-v fa-w-14 fa-3x">
