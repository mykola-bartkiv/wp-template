            ...
            <?php elseif ( get_row_layout() == 'youtube' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Youtube</span>
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-youtube fa-w-18 fa-3x">
            ...
            <?php elseif ( get_row_layout() == 'vimeo' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Vimeo</span>
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="vimeo-v" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="svg-inline--fa fa-vimeo-v fa-w-14 fa-3x">
            ...
            <?php elseif ( get_row_layout() == 'pinterest' ): ?>
                <a href="<?php the_sub_field( 'url' ); ?>"
                   ...
                   target="_blank"><span class="link-text">Pinterest</span>
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="pinterest-p" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-pinterest-p fa-w-12 fa-3x">
